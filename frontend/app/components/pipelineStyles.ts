export const commonPipelineStyles = {
  ...
  card: "rounded-2xl border border-[#00508f]/70 bg-[#00264d]/92 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.32)]",
...
export const predictionPageStyles = {
  ...
  errorPanel: "rounded-md border border-[#ffc300]/28 bg-[#001a36]/88 p-4",
  errorPanelTitle: "font-medium text-[#ffd60a]",
  errorPanelBody: "mt-1 text-sm text-[#fff8d6]",
  summaryGrid: "grid grid-cols-3 gap-4",
  summaryCard: "rounded-xl border border-[#00508f]/70 bg-[#001a36]/82 p-4",
